        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="w-full animate-fade-in animate-slide-up animation-delay-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="card overflow-hidden border border-card-border bg-card-bg rounded-xl flex flex-col h-full group hover:border-neutral-700/80 transition-all duration-300">
                <a 
                ...
                <div className="p-5 flex flex-col flex-grow justify-between gap-y-4">
                  <div>
                    ...
                    <ul className="mt-2 flex flex-col gap-1.5 text-sm text-neutral-400 pl-3 border-l border-neutral-800/80">
